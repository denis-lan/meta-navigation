...
*/
  ...
  */
  ...
  board.instructions1 = {};
  board.instructions1.rect   = [board.paper.centre[0]-((board.paper.width * 0.85)/2), board.paper.centre[1]-(((board.paper.width * 0.85) / 1114 * 520)/2), board.paper.width * 0.85, (board.paper.width * 0.85) /  1114 * 520];
  ...
  board.instructions3 = {};
  board.instructions3.rect   = [board.paper.centre[0]-((board.paper.width * 0.85)/2), board.paper.centre[1]-(((board.paper.width * 0.85) / 1376 * 796)/2), board.paper.width * 0.9, (board.paper.width * 0.85) / 1376 * 796];
