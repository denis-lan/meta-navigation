...
function handleResponse(key, category, responsetype) {
  if(coding.answering && !coding.feedbackshown){
    ...
    if(isnan(category)) {
      ...
      //coding.answering = false;
      if(key == 'Right'){
        if (coding.xloc < coding.totcols - 2 & goalorstart[coding.xloc + 1][coding.yloc] != 9998){
        ...
        if (coding.xloc > 1 & goalorstart[coding.xloc - 1][coding.yloc] != 9998){
          //board.gridcontent[coding.yloc][coding.xloc].object.attr({"text": ""});
          newxloc = coding.xloc - 1;
          newyloc = coding.yloc;
          moved = true;
        ...
        if (coding.yloc > 1 & goalorstart[coding.xloc][coding.yloc - 1] != 9998){
          //board.gridcontent[coding.yloc][coding.xloc].object.attr({"text": ""});
        ...
        if (coding.yloc < coding.numrows - 2 & goalorstart[coding.xloc][coding.yloc + 1] != 9998){
          //board.gridcontent[coding.yloc][coding.xloc].object.attr({"text": ""});
          newyloc = coding.yloc + 1;
          newxloc = coding.xloc;
          moved = true
        ...
        setTimeout(function () {
          ...
          setTimeout(function(){
            ...
            if(coding.block == 0){ //code for practice block, not currently used (change to 0 to set first block)
              ...
              if(sdata.resp_validkeypresses[coding.index].length >= parameters.practicetrialsteps && coding.practicedboth){
                endTrial(false);
              }
            }
            else{
