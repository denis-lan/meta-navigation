...
*/
  ...
  */
  ...
  board.instructions1 = {};
  board.instructions1.rect   = [board.paper.centre[0]-((board.paper.width * 0.85)/2), board.paper.centre[1]-(((board.paper.width * 0.85) / 1328 * 721)/2), board.paper.width * 0.85, (board.paper.width * 0.85) /  1328 * 721];
