...
function shuffle(array) {
  ...
  sdata.cond_freeorforced = Array(25).fill(0);
  // sdata.cond_freeorforced = [0].concat(Array(24).fill(999));
  // sdata.cond_blocknumlandmarks = shuffle([2, 4, 8, 16]);
  sdata.cond_blocknumlandmarks = [0, 0, 0, 0];
  sdata.cond_numlandmarks = [0].concat(sdata.cond_blocknumlandmarks.flatMap(x => Array(6).fill(x)));
